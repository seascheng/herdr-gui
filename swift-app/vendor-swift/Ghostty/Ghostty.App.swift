...
extension Ghostty {
    ...
    class App: ObservableObject {
        ...
        private static func checkForUpdates(
            ...
            // HERDR-GUI: Sparkle-based updates are not part of this shell.
        }
        ...
        private static func toggleVisibility(
            ...
            // HERDR-GUI: no dock visibility toggling in this shell.
        }
        ...
        private static func gotoSplit(
            ...
            direction: ghostty_action_goto_split_e) -> Bool {
                // HERDR-GUI: split navigation is handled by Herdr itself.
                _ = target
                _ = direction
                return false
        }
        ...
        private static func gotoWindow(
            ...
            while index != startIndex {
                ...
                if candidate.isVisible, !candidate.isMiniaturized {
                    ...
                    // HERDR-GUI: surface focus handled by key window.
                    return true
                }
        ...
        private static func toggleFloatWindow(
            ...
            case GHOSTTY_TARGET_SURFACE:
                ...
                // HERDR-GUI: no float-on-top menu to sync.
        ...
        private static func toggleBackgroundOpacity(
            ...
            case GHOSTTY_TARGET_SURFACE:
                break // HERDR-GUI: background opacity toggle not wired.
        ...
        private static func toggleSecureInput(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                SecureInput.shared.setScoped(ObjectIdentifier(SecureInput.shared), focused: mode == .on)
